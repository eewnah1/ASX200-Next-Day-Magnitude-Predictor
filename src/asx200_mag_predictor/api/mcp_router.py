...
PAGE = """<!DOCTYPE html><html><head><meta charset=utf-8><title>Free MCP stack</title>
<style>body{font-family:sans-serif;background:#0b1220;color:#e2e8f0;margin:24px}pre{background:#111827;padding:12px;border-radius:8px;overflow:auto;max-height:70vh}button{margin:4px;padding:8px 12px}</style></head>
<body><h1>Free MCP stack</h1>
<p>Yahoo + APAC quotes + quant tilt + remote MCP probes.</p>
<div>
